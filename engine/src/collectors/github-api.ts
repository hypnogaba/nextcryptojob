 ...
 * api.github.com, ліміт пошуку (свій, 30 на хвилину) чекає лише цей виклик. Сам пошук
 * іде окремим бюджетом limits.ts ("github-search", 1 запит на 2 с), тож GraphQL не стоїть за ним.
