...
- `users.is_demo = 0` (0020, доріжка web): синтетичні кандидати демо-компанії добірки не
  отримують ніколи. Поки 0020 не накочено, колонки немає, запит іде без цієї умови.
