...
1. Кеш NextRole, D1 `crypto-jobs-agent` (`0bf4b998-…`), **лише читання**: `jobs-db.ts` віддає назовні
   ...
   тож це повний прохід: 12.09 `rows_read` = 56 955, D1 63–86 мс, 0,4–0,6 с від ноутбука, 2 476 рядків відповіді.
...
Чистка кешу NextRole (12.09 на 2 476 живих рядках з тегом web3 лишилось 1 799, тобто 73%): список не-крипто
...
нашу роль (`titleRoles`, словник спільний з `web/src/lib/roles/suggest.ts`), разом 109 рядків.
