// Чистка кешу вакансій NextRole перед добіркою.
//
// Кеш спільний з NextRole, і тег web3 там ставить не лише крипто: 12.09 на живому
// кеші серед 3 101 свіжої вакансії з тегом web3 були розшифровувачі аудіо (Perle),
// будівельники центрів обробки даних (Crusoe), страхування, реклама Microsoft,
// безпека пошти й мереж. Три сита, всі детерміновані:
