...
// що написала «smart contract developer», не впізнає своїх вакансій. Правити обидва
// місця разом. Нижче лише доповнення для назв вакансій, яких у тексті людини не буває.
import type { RoleKey } from "../types.js";

/** Порядок договору §1: за рівної ваги перша роль у цьому списку. */
 ...
 * живому кеші попереднього проєкту 12.09: розшифровувачі аудіо, кухарі, будівельні інженери
