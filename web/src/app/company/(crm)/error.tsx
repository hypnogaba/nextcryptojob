...
export default function CrmError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="mx-auto grid max-w-7xl gap-4 px-[clamp(16px,4vw,56px)] pt-8 pb-20 *:max-w-3xl sm:pt-12">
      <div role="alert" className="grid gap-2 rounded-lg border border-destructive/50 bg-surface px-4 py-3 text-sm text-ink">
