...
/**
 * Підтвердження GitHub кодом у біо. Рушій рахує лише підтверджений GitHub і лише
 * через нього (або X) приймає профіль Sherlock; картку інженера без нього не створити.
 */
  ...
  return (
    <section aria-labelledby="gh-verify" className="grid gap-3">
      ...
      <p className="text-sm text-ink-muted">
        We count GitHub only once you prove it is yours. Verifying GitHub also links your Sherlock audits.
      </p>
