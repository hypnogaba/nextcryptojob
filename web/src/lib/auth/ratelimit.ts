...
/**
 * Вікняне обмеження спроб на D1 (за мотивами попереднього проєкту, src/lib/ratelimit.ts).
 *
 * Стан у таблиці auth_attempts, а не в пам'яті: ізоляти Workers живуть
 * недовго, і лічильник у пам'яті скидався б сам собою.
 *
 * Відмінності від попереднього проєкту:
 * - одна інструкція consume() і рахує спробу, і вирішує, чи пустити. У
 *   Там «перевірив» і «записав» були двома запитами, і 30 паралельних
