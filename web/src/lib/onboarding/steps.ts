...
// щоденна добірка вже може йти. Далі кроки балу: X і гаманець обов'язкові (власник 13.09, потім
// 15.09: гаманець такий же обов'язковий, як X), без них далі не пускаємо; інші джерела
// необов'язкові, кожне піднімає бал. Хто пройшов усе до 15.09 без гаманця, не блокуємо: підказка
// додати його чекає на /profile. Після кроків балу /welcome/score ставить бал у чергу, чекає на
// нього й показує картку.
